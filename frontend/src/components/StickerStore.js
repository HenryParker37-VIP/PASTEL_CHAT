...
const StickerStore = ({ onClose, onPacksChanged }) => {
  ...
  return <div className="sticker-store" onClick={event => event.stopPropagation()}>
    ...
    <div className="store-hero"><div><span className="store-eyebrow">PASTELCHAT ORIGINALS</span><h2>Small characters, big feelings.</h2><p>Find a gentle reaction for every conversation.</p></div><StickerDisplay imageUrl={LOCAL_STICKER_PACKS[0].cover} label="Pastel Bunny" size="large" /></div>
