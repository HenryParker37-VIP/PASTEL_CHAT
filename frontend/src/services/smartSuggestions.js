...
const CONCEPTS = [
  { id: 'affection', phrases: ['love', 'yêu', 'thương', 'miss you', 'miss u', 'nhớ bạn', 'nhớ you', 'nhớ em', 'nhớ anh', 'nhớ m', 'i miss', 'like you', 'thích bạn'], emotion: 'love', tone: 'tender', intent: 'affection', gif: 'cute love reaction' },
  ...
  { id: 'sleep', phrases: ['ngủ ngon', 'ngủ nha', 'good night', 'buồn ngủ', 'sleepy', 'sleep', 'bed', 'đi ngủ'], emotion: 'calm', tone: 'tender', intent: 'greeting', gif: 'good night cute' },
  ...
  { id: 'approval', phrases: ['ok', 'okay', 'good', 'nice', 'được', 'chuẩn'], emotion: 'approval', tone: 'positive', intent: 'confirm', gif: 'thumbs up reaction' }
];
