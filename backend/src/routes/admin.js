...
function emitNotification(io, notification) {
  if (io && notification) emitToUser(io, notification.userId, `notify:${notification.userId}`, { type: notification.type, notificationId: notification._id, data: notification.data });
}
